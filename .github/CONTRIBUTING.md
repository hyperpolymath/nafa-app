...
# Contributing — nafa-app

## Audience

Developers working **on** `nafa-app`. For consumers (people calling or
...
``` bash
git clone git@github.com:hyperpolymath/nafa-app.git
cd nafa-app
...
- Bugs in `nafa-app`: file at `hyperpolymath/nafa-app/issues`.
