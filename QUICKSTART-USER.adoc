...
// Replace nafa-app, Nafa App — See README.adoc for details., just run, Nafa App started successfully. with actuals
= nafa-app — Quick Start for Users
:toc:
:toclevels: 2

== What is nafa-app?

Nafa App — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nafa-app-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/nafa-app/wiki
