...
NAFA is licensed under *PMPL-1.0-or-later* (Palimpsest-MPL License 1.0 or later).

All source files include SPDX license headers: `SPDX-License-Identifier: PMPL-1.0-or-later`

== Links

* Project: https://github.com/hyperpolymath/nafa-app
* Issues: https://github.com/hyperpolymath/nafa-app/issues
